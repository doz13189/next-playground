...
export const skills: z.infer<typeof SkillsSchema> = {
  skills: [
    ...
    },
    {
      name: "状態変化解除",
      description:
        '一時的な強化を<span style="color:#3C9A66;">X</span>つ解除する',
    },
    {
      name: "状態異常解除",
      description: '一時的な<span style="color:#3C9A66;">X</span>を解除する',
    },
    {
      name: "強奪",
      description:
        '敵の一時的な強化を<span style="color:#3C9A66;">X</span>個解除し、解除した強化を自分に付与する',
    },
    {
      name: "状態異常効果ターン短縮",
    ...
    {
      name: "状態変化解除",
      description: '状態異常を<span style="color:#3C9A66;">X</span>つ回復する',
    },
    {
      name: "状態変化解除",
      description: '一時的な<span style="color:#3C9A66;">X</span>を解除する',
    ...
    {
      name: "パワーアップ",
      description: 'パワーが<span style="color:#3C9A66;">X</span>%アップ',
      iconUrl: "/assets/buffs_debuffs/battle_status_icon_buff_001.webp",
    },
    {
      name: "ディフェンスアップ",
      description: 'ディフェンスが<span style="color:#3C9A66;">X</span>%アップ',
      iconUrl: "/assets/buffs_debuffs/battle_status_icon_buff_002.webp",
    },
    {
      name: "スピードアップ",
      description: 'スピードが<span style="color:#3C9A66;">X</span>%アップ',
      iconUrl: "/assets/buffs_debuffs/battle_status_icon_buff_003.webp",
    },
    {
      name: "クリティカル率アップ",
      description:
        'クリティカル率が<span style="color:#3C9A66;">X</span>%アップ',
    ...
    {
      name: "ダメージカット",
      description: 'ダメージを<span style="color:#3C9A66;">X</span>%軽減する',
    ...
    },
    {
      name: "被ダメージ回復",
      description:
        '受けたダメージの<span style="color:#3C9A66;">X</span>%、ターン終了時にHPが回復する',
      iconUrl: "/assets/buffs_debuffs/battle_status_icon_buff_011.webp",
    },
    {
      name: "高揚",
      description:
        'プルスウルトラゲージ上昇量が<span style="color:#3C9A66;">X</span>%アップ',
    ...
    // },
    {
      name: "発勁",
      description:
        '現在値：<span style="color:#3C9A66;">X</span>　様々な条件によりカウントが増減し、カウント数値に応じてスキルの効果が変化する',
      iconUrl: "/assets/buffs_debuffs/battle_status_icon_buff_012.webp",
    },
    {
      name: "くいしばり",
    ...
    {
      name: "スキル威力アップ",
      description: 'スキル威力が<span style="color:#3C9A66;">X</span>%アップ',
      iconUrl: "/assets/buffs_debuffs/battle_status_icon_buff_019.webp",
    },
    {
      name: "アクションスキル威力アップ",
      description:
        'アクションスキルの威力が<span style="color:#3C9A66;">X</span>%アップ',
      iconUrl: "/assets/buffs_debuffs/battle_status_icon_buff_019.webp",
    },
    {
      name: "プルスウルトラ技威力アップ",
      description:
        'プルスウルトラ技の威力が<span style="color:#3C9A66;">X</span>%アップ',
      iconUrl: "/assets/buffs_debuffs/battle_status_icon_buff_019.webp",
    },
    {
      name: "クールタイム短縮",
    ...
    },
    {
      name: "HP自動回復",
      description:
        '毎ターン、HPが<span style="color:#3C9A66;">X</span>%回復する',
    ...
    {
      name: "最大HPアップ",
      description: '最大HPが<span style="color:#3C9A66;">X</span>%アップ',
    ...
    },
    {
      name: "クリティカル威力アップ",
      description:
        'クリティカル発生時の威力が<span style="color:#3C9A66;">X</span>%アップ',
      iconUrl: "/assets/buffs_debuffs/battle_status_icon_buff_028.webp",
    },
    {
      name: "与ダメージ回復",
      description:
        '与えたダメージの<span style="color:#3C9A66;">X</span>%HPが回復する',
      iconUrl: "/assets/buffs_debuffs/battle_status_icon_buff_029.webp",
    },
    // {
    //   name: "クリティカルダメージ軽減",
    //   description:
    //     'クリティカル発生時のダメージを<span style="color:#3C9A66;">X</span>%軽減する',
    //   iconUrl: "/assets/buffs_debuffs/battle_status_icon_buff_030.webp",
    // },
    {
      name: "スキルダメージ軽減",
      description:
        'スキルダメージを<span style="color:#3C9A66;">X</span>%軽減する',
      iconUrl: "/assets/buffs_debuffs/battle_status_icon_buff_030.webp",
    },
    {
      name: "アクションスキルダメージ軽減",
      description:
        'アクションスキルのダメージを<span style="color:#3C9A66;">X</span>%軽減する',
      iconUrl: "/assets/buffs_debuffs/battle_status_icon_buff_030.webp",
    },
    {
      name: "プルスウルトラ技ダメージ軽減",
      description:
        'プルスウルトラ技のダメージを<span style="color:#3C9A66;">X</span>%軽減する',
      iconUrl: "/assets/buffs_debuffs/battle_status_icon_buff_030.webp",
    },
    {
      name: "通常攻撃威力アップ",
      description:
        '通常攻撃の威力が<span style="color:#3C9A66;">X</span>%アップ',
      iconUrl: "/assets/buffs_debuffs/battle_status_icon_buff_031.webp",
    },
    // {
    //   name: "通常攻撃ダメージ軽減",
    //   description:
    //     '通常攻撃のダメージを<span style="color:#3C9A66;">X</span>%軽減する',
    //   iconUrl: "/assets/buffs_debuffs/battle_status_icon_buff_032.webp",
    // },
    {
      name: "燃焼・出血ダメージ軽減",
      description:
        '燃焼・出血のダメージを<span style="color:#3C9A66;">X</span>%軽減する',
      iconUrl: "/assets/buffs_debuffs/battle_status_icon_buff_033.webp",
    },
    {
      name: "燃焼ダメージ軽減",
      description:
        '燃焼のダメージを<span style="color:#3C9A66;">X</span>%軽減する',
      iconUrl: "/assets/buffs_debuffs/battle_status_icon_buff_033.webp",
    },
    {
      name: "出血ダメージ軽減",
      description:
        '出血のダメージを<span style="color:#3C9A66;">X</span>%軽減する',
      iconUrl: "/assets/buffs_debuffs/battle_status_icon_buff_033.webp",
    },
    // {
    //   name: "凍傷ダメージ軽減",
    //   description:
    //     '凍傷のダメージを<span style="color:#3C9A66;">X</span>%軽減する',
    //   iconUrl: "/assets/buffs_debuffs/battle_status_icon_buff_033.webp",
    // },
    {
      name: "霜ダメージ軽減",
      description:
        '霜のダメージを<span style="color:#3C9A66;">X</span>%軽減する',
      iconUrl: "/assets/buffs_debuffs/battle_status_icon_buff_033.webp",
    },
    {
      name: "不屈",
      description:
        '戦闘不能になってもHP1で耐える　効果終了時に戦闘不能になる　ダメージを与える際、失ったHPの<span style="color:#3C9A66;">X</span>%のダメージを追加で与える',
    ...
    {
      name: "ストレス",
      description: '現在値：<span style="color:#3C9A66;">X</span>',
      iconUrl: "/assets/buffs_debuffs/battle_status_icon_buff_041.webp",
    },
    // {
    //   name: "連撃",
    //   description:
    //     'スキル使用時、スキルを<span style="color:#3C9A66;">X</span>連続で使用するようになる',
    //   iconUrl: "/assets/buffs_debuffs/battle_status_icon_buff_042.webp",
    // },
    {
      name: "クリティカル抵抗アップ",
      description:
        'ダメージを受けた時にクリティカルとなる確率が<span style="color:#3C9A66;">X</span>%ダウン',
      iconUrl: "/assets/buffs_debuffs/battle_status_icon_buff_043.webp",
    },
    {
      name: "見切り",
      description:
        '通常攻撃とアクションスキルを<span style="color:#3C9A66;">X</span>%で回避する　この回避率は自分の一時的な状態異常1個につき5%減少する',
    ...
    },
    {
      name: "クールタイム軽減",
      description:
        'アクションスキルを使用した時、発生するクールタイムが<span style="color:#3C9A66;">X</span>減少する',
    ...
    },
    {
      name: "プルスウルトラ効率アップ",
      description:
        'プルスウルトラ技使用時に消費されるプルスウルトラゲージを<span style="color:#3C9A66;">X</span>%軽減する',
    ...
    },
    {
      name: "索敵",
      description:
        '自分の単体攻撃が全て隠れる状態の敵に向く　隠れる状態の敵に与えるダメージが<span style="color:#3C9A66;">X</span>%アップする',
      iconUrl: "/assets/buffs_debuffs/battle_status_icon_buff_052.webp",
    },
    {
      name: "自然体",
      description:
        '貫通によるダメージを受ける時、またはダメージを与える時において、ダメージ軽減無視効果が<span style="color:#3C9A66;">X</span>%軽減される',
      iconUrl: "/assets/buffs_debuffs/battle_status_icon_buff_053.webp",
    },
    {
      name: "受け流し",
      description:
        'ダメージ割合：<span style="color:#3C9A66;">X</span>%\nダメージを受けた時、そのダメージに対して見切りの効果値<span style="color:#3C9A66;">{1}</span>%分のダメージを相手に与える\nこの効果は見切りと同時に付与されている時に効果を発揮する',
    ...
    {
      name: "スキル威力ダウン",
      description: 'スキルの威力が<span style="color:#ff6f6f;">X</span>%ダウン',
      iconUrl: "/assets/buffs_debuffs/battle_status_icon_debuff_019.webp",
    },
    {
      name: "アクションスキル威力ダウン",
      description:
        'アクションスキルの威力が<span style="color:#ff6f6f;">X</span>%ダウン',
      iconUrl: "/assets/buffs_debuffs/battle_status_icon_debuff_019.webp",
    },
    {
      name: "プルスウルトラ技威力ダウン",
      description:
        'プルスウルトラ技の威力が<span style="color:#ff6f6f;">X</span>%ダウン',
      iconUrl: "/assets/buffs_debuffs/battle_status_icon_debuff_019.webp",
    },
    {
      name: "クールタイム延長",
    ...
    {
      name: "最大HPダウン",
      description: '最大HPが<span style="color:#ff6f6f;">X</span>%ダウン',
    ...
    // },
    {
      name: "凍傷",
      description:
        'スキルチェインに参加できなくなり、与えたダメージの<span style="color:#ff6f6f;">X</span>%を自分も受けるようになる',
    ...
    },
    {
      name: "クリティカル抵抗ダウン",
      description:
        'ダメージを受けた時にクリティカルとなる確率が<span style="color:#ff6f6f;">X</span>%アップ',
      iconUrl: "/assets/buffs_debuffs/battle_status_icon_debuff_026.webp",
    },
    // {
    //   name: "クリティカル威力ダウン",
    //   description:
    //     'クリティカル発生時の威力が<span style="color:#ff6f6f;">X</span>%ダウン',
